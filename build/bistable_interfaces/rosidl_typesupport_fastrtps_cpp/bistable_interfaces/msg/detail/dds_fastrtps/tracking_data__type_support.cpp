...
#include "bistable_interfaces/msg/detail/tracking_data__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = bistable_interfaces::msg::TrackingData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const bistable_interfaces::msg::TrackingData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<bistable_interfaces::msg::TrackingData *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TrackingData__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const bistable_interfaces::msg::TrackingData *>(
...
static size_t _TrackingData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TrackingData(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _TrackingData__callbacks = {
...
static rosidl_message_type_support_t _TrackingData__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TrackingData__callbacks,
...
{
  return &bistable_interfaces::msg::typesupport_fastrtps_cpp::_TrackingData__handle;
}
